...
# tmp <- cbind(rownames(rna_expressed_norm), rna_expressed_norm)
# colnames(tmp)[1] <- "gene_id"
# openxlsx::write.xlsx(tmp, '/Volumes/My Passport/hd_in/09.19_hd/3_stdmapping/1_readcounts/gene_count_matrix_2_norm_sizeFactors.xlsx')
dds_rna$sizeFactor
