...
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/in_rna_upreg_biological_process.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/in_rna_upreg_biological_process_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth= 10)
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/in_rna_downreg_biological_process.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/in_rna_downreg_biological_process_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 15, pdf_heigth= 15)

# Molecular function
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/in_rna_upreg_molecular_function.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/in_rna_upreg_molecular_function_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth= 15)
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/in_rna_downreg_molecular_function.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/in_rna_downreg_molecular_function_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth = 15)

# Biological process
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/fb_rna_upreg_biological_process.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/fb_rna_upreg_biological_process_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth= 10)
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/fb_rna_downreg_biological_process.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/fb_rna_downreg_biological_process_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 15, pdf_heigth= 15)

# Molecular function
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/fb_rna_upreg_molecular_function.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/upregulated/fb_rna_upreg_molecular_function_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth= 15)
GO_json(file_name='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/fb_rna_downreg_molecular_function.json', prefix='/Volumes/My Passport/hd_in/07.20_hd/3_stdmapping/GO_analysis/downregulated/fb_rna_downreg_molecular_function_', morethan = 2, botlog2fc = -0.5, toplog2fc = 0.5, pdf_width = 20, pdf_heigth = 15)
